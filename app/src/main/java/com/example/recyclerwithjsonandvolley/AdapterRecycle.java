...
public class AdapterRecycle extends RecyclerView.Adapter<AdapterRecycle.MyViewHolder> {
    ...
    public AdapterRecycle() {
    }

    public AdapterRecycle(Context context, ArrayList<ModelItem> arrayList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterRecycle.MyViewHolder holder, int position) {
